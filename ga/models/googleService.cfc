<cfcomponent>
	<cfproperty name="oauthSettings" inject="coldbox:modulesettings:ga" >
 	...
 	<cffunction name="googleOauth2Login" access="public" hint="GA account authorization">
        ...
        <cfhttp url="#arguments.gaOauthUrl#" method="post">
       		...
       		<cfhttpparam name="client_id" type="formField" value="#oauthSettings['client_id']#">
       		<cfhttpparam name="client_secret" type="formField" value="#oauthSettings['client_secret']#">
       		<cfhttpparam name="redirect_uri" type="formField" value="#oauthSettings['redirect_uri']#">
    ...
    <cffunction name="ReStartinit" access="public" hint="initialize vars">
   		<cfscript>
			var dataExportURL = "";
			var startEndDates = "";
    ...
    <cffunction name="parseData" access="public" returntype="array" hint="GA data as array of structures">
        ...
        <cfscript>
         ...
         <cfif StructKeyExists(dataNodes,"error") AND dataNodes.error.message EQ "Forbidden">
            ...
            <cflocation url="index" addtoken="no"/>
         <cfelse> 
         	<cfif StructKeyExists(dataNodes,'rows') AND ArrayLen(dataNodes.rows) gt 0>
